  ...
  return (
    <div className="basis-1/2 pl-2 mr-2">
      ...
      <div className="border-b border-border border-solid">
        <span className="font-light mt-4 text-base font-extralight block mb-2 text-[#83889e]">
          PLATFORMS AVAILABLE
        </span>
        <div className="flex my-8 text-[#3c3e49]">
          <BsPhone className="mr-8" />
          <span className="text-sm">iOS app for Apple (iPhones)</span>
        </div>
        <div className="flex my-8 text-[#3c3e49]">
          <MdPhoneAndroid className="mr-8" />
          <span className="text-sm">Android app (for Android phones)</span>
        </div>
        <div className="flex my-8 text-[#3c3e49]">
          <AiOutlineDesktop className="mr-8" />
